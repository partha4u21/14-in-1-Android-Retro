...
package com.multiplyone.handheld.classes;

import static com.multiplyone.handheld.SharedData.drawExplosion;
import static com.multiplyone.handheld.SharedData.drawFading;
import static com.multiplyone.handheld.SharedData.drawGameOver;
import static com.multiplyone.handheld.SharedData.games;
...
import static com.multiplyone.handheld.SharedData.nextLevel;
...
import static com.multiplyone.handheld.SharedData.timerCounter2;
...
public abstract class Game {
    ...
    public static void setActivitySoftReference(SoftReference<Activity> activityReference) {
        activitySoftReference = activityReference;
    }
    ...
    public void nextLevel() {
        ...
        //call to switch to the nextlevel directly. it will increase the speed after level 9
        if (!nextLevel) {
            nextLevel = true;
            sEvent = 1;
            playSound(6);
