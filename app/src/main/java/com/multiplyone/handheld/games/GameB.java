...
public class GameB extends Game {
    ...
    public void input() {
        if (input == 3 && mPlayer > 0) {
            if (mDirection[0] && mBall[1] == FIELD_HEIGHT - 2
                    && mBall[0] >= mPlayer && 
                    mBall[0] <= mPlayer + 3) {
                if (mBall[0] > 0)
                    mBall[0]--;
            ...
            if (mDirection[0] && mBall[1] == FIELD_HEIGHT - 2 && mBall[0] >= mPlayer && mBall[0] <= mPlayer + 3) {
                if (mBall[0] != 9)
                    mBall[0]++;
    ...
    private void playerCollision() {
        if (mBall[1] == FIELD_HEIGHT - 2 && mDirection[2]) {
            mPlaySound=true;
